...
feature_mappings = {
    'feature1':
        ([0.01],
         tf.train.Feature(float_list=tf.train.FloatList(value=[0.01])),
         np.array([[0.01]])),
    'feature2':
        ([1],
    ...
    'feature3':
        (["value"],
         tf.train.Feature(bytes_list=tf.train.BytesList(value=[b"value"])),
         np.array([[b"value"]])),
    'feature4':
        ([0, 1],
         tf.train.Feature(int64_list=tf.train.Int64List(value=[0, 1])),
         np.array([[0, 1]])),
    'feature5':
        ([1, 1, 2],
         tf.train.Feature(int64_list=tf.train.Int64List(value=[1, 1, 2])),
         np.array([1, 1, 2]))
}
...
feature_mappings_null_without_defaults = {
    ...
    'feature3':
        (None,
         tf.train.Feature(bytes_list=tf.train.BytesList(value=[b""])),
         np.array([[b""]])),
    'feature4':
        (None,
         tf.train.Feature(int64_list=tf.train.Int64List(value=[0, 0])),
         np.array([[0, 0]])),
    'feature5':
        (None,
         None,
...
feature_mappings_with_inconsistent_size = {
    'feature4':
        ([1, 2, 3],
         None,
         None)
...
all_mappings = [
    feature_mappings, feature_mappings_without_lists, feature_mappings_null_without_defaults,
    feature_mappings_empty_without_defaults, feature_mappings_null_with_defaults]
