...
from ml_hadoop_experiment.tensorflow.predictor import (Predictor, feeds_type,
                                                       fetches_type)
...
def graph_model(
    sparkSession: pyspark.sql.SparkSession, export_model_path: str, feeds: feeds_type, fetches: fetches_type
) -> SerializableObj:
    """
